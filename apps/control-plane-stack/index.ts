...
new runner.SSHDeployer(
  "setup-machine",
  {
    ...
    environment: {
      ...
      SITE_NAME: siteConfig.get("name") ?? "Faremeter Marketplace",
      DOCS_URL: siteConfig.get("docsUrl") ?? "https://docs.faremeter.xyz",
      SALES_EMAIL: siteConfig.get("salesEmail") ?? "sales@faremeter.xyz",
