...
export default function ProxyDetailPage() {
  ...
  const handleActivate = async () => {
    ...
    try {
      await api.post(
        `/api/organizations/${currentOrg.id}/tenants/${tenant.id}/activate`,
      );
      toast({
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-11">
                        A backend URL must be configured before going live. Go
                        to Settings and add your backend URL.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-md border border-red-800 bg-red-900/20 p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-11">
                        A wallet must be assigned before going live. Go to
                        Settings and select a wallet.
                      </p>
                    </div>
                  </div>
                </div>
