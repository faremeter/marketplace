export const OPENAPI_USPTO = {
  ...
  tags: [
    { name: "metadata", description: "Find out about the data sets" },
    { name: "search", description: "Search a data set" },
  ],
  paths: {
    "/": {
      get: {
      ...
      post: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: true,
            schema: { type: "string", default: "oa_citations" },
          },
        ],
        responses: {
          "200": {
